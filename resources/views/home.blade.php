                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('password.store') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="password_name"
                                                    id="recipient-name">
                                            </div>
                                            <div class="mb-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" data-bs-toggle="modal"
                                                    data-bs-target="#confirmationModal" href="">Delete</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('password.update', ['password_id' => $password['password_id']]) }}"
                            method="POST">
                            @method('put')
                            @csrf
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Password name:</label>
                                <input type="text" class="form-control" name="new_password_name" id="recipient-name" placeholder="40 characters max"
